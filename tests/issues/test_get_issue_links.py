...
class TestGetIssueLinks:
    ...
    def test_get_links_success(self, api_client_1):
        issue_id = "TES-1"

        with allure.step("Отправляем GET запрос для получения связей задачи"):
            response = api_client_1.get_issue_links(issue_id)
    ...
    def test_get_links_nonexistent_issue(self, api_client_1):
        response = api_client_1.get_issue_links("NONEXISTENT-999")
    ...
    def test_get_links_no_links(self, api_client_1):
        issue_id = "TES-3"
