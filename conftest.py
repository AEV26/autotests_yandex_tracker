...
import time
import requests
from utils.api_client import TrackerAPIClient, TrackerApiClient,Tracker_API_Client
...
def full_issue_data():
    return {
        "queue": "TESTAST",
        "summary": "Full test issue from pytest",
...
@pytest.fixture
def created_issue(api_client_2):
    issue_data = {
        "queue": "TESTAST",
        "summary": "Test issue for PATCH operations",
        "description": "Will be deleted after tests"
    }
...
@pytest.fixture
def existing_issue_id(api_client_2):
    issue_data = {
        "queue": "TESTAST",
        "summary": f"Test issue for get operation - {uuid.uuid4()}",
    }
